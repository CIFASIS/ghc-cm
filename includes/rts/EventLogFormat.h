...
#define EVENT_PROC                200 /* (name) */
#define EVENT_PROC_END            201 /* (name) */
#define EVENT_PROC_RANGE          202 /* (start, end) */
#define EVENT_PROC_SOURCE_NOTE    203 /* (name, start_line, start_col,
                                          end_line, end_col) */

#define EVENT_STAT_PROF_SAMPLES   210
